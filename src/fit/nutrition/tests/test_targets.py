...
from fit.nutrition.data_models import WeightGoals
...
class TestTargets(unittest.TestCase):
    def test_calculate_caloric_target(self):
        self.assertEqual(calculate_caloric_target(2000, WeightGoals.GAIN), 2200)
        self.assertEqual(calculate_caloric_target(2000, WeightGoals.LOSE), 1800)
        self.assertEqual(calculate_caloric_target(2000, WeightGoals.MAINTAIN), 2000)
        self.assertEqual(calculate_caloric_target(0, WeightGoals.MAINTAIN), 0)
    ...
    def test_calculate_macro_targets(self):
        result = calculate_macro_targets(2000, WeightGoals.GAIN)
        ...
        result = calculate_macro_targets(2000, WeightGoals.LOSE)
        ...
        result = calculate_macro_targets(2000, WeightGoals.MAINTAIN)
