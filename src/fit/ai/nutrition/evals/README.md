...
```python
python -m fit.ai.nutrition.evals.meal_breakdown_eval
python -m fit.ai.nutrition.evals.inventory_breakdown_eval
python -m fit.ai.nutrition.evals.recommendation_eval
```
