...
MICRO_DEFAULT = Micronutrients(
    vitamin_a=0, vitamin_c=0, vitamin_d=0, calcium=0, iron=0, potassium=0, sodium=0
)
...
class NutritionalInformation(BaseModel):
    ...
    macronutrients: Macronutrients = Field(
        description="the macronutrients in the food", default=MACRO_DEFAULT
    )
    micronutrients: Micronutrients = Field(
        description="the micronutrients in the food", default=MICRO_DEFAULT
    )
    conditional_nutrients: ConditionalNutrients = Field(
        description="the conditional nutrients in the food", default=COND_DEFAULT
    )
...
class MealTypeRecommendations(BaseModel):
    ...
    meals: List[MealRecommendation] = Field(
        description="list of 5 recommended meals of this type"
    )
